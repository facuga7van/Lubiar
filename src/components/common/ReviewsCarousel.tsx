    ...
    <section className="py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <SwiperSlide key={i} className="">
              <div
                className="group bg-white border border-gray-300 rounded-xl p-6
                  transition-all duration-500 w-full mx-auto
                  hover:border-indigo-600 hover:shadow-sm mb-10"
              >
        ...
        <div className="mt-10 text-center">
          ...
          >
            <button
              className="mt-4 px-6 py-3 filterHighlight buttonLub text-white
                font-semibold rounded-lg transition"
            >
              Dejá tu opinión en Facebook
            </button>
          </Link>
        </div>
      </div>
